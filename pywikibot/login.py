...
class LoginManager(object):
    ...
    def check_user_exists(self):
        ...
        @raises pywikibot.exceptions.NoUsername: Username doesn't exist in user list.
        """
    ...
    def login(self, retry=False, autocreate=False):
        ...
        @raises pywikibot.exceptions.NoUsername: Username is not recognised by the site.
        """
